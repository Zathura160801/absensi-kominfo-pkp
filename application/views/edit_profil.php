                    ...
                    <div class="card">
                        <form action="<?= base_url('user/update_foto') ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-footer">
                                ...
                                <button type="submit" class="btn bg-lightblue btn-block mt-2">Simpan <i
                    ...
                    <div class="card">
                        <form action="<?= base_url('user/edit_profil') ?>" method="post">
                            ...
                            <div class="card-body border-top py-0 my-3">
                                    ...
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nik" id="nik" value="<?= $user->nik ?>"
                                                class="form-control" placeholder="Masukan NIK Karyawan" disabled
                                                required="reuqired" />
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama" id="nama" value="<?= $user->nama ?>"
                                                class="form-control" placeholder="Masukana Nama Lengkap Karyawan"
                                                required="reuqired" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div
                                        class="col-xs-12 <?= ($this->session->level == 'Karyawan') ? 'col-sm-6 col-md-4' : 'col-sm-6' ?>">
                                        <div class="form-group">
                                            <label for="telp">No. Telp : </label>
                                            <input type="tel" name="telp" id="telp" value="<?= $user->telp ?>"
                                    ...
                                    <?php if ($this->session->level == 'Karyawan'): ?>
                                        <div class="col-xs-12 col-sm-12 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="divisi" id="divisi" value="<?= $user->divisi ?>"
                                                    class="form-control">
                                    ...
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="username" id="username"
                                                ...
                                                placeholder="Masukan Username" required="reuqired" />
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group">
                            ...
                            <div class="card-footer">
                                <div class="row w-100">
                                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                                        <button type="submit" class="btn btn-block bg-maroon">Simpan <i
                                                class="fa fa-save"></i></button>
                                    </div>
                                </div>
                            </div>
